...
def positive_assert(first_name):
    ...
    print("\n" + str(sender_stand_request.response.status_code))
    print("\n" + "el AUTH_THOKEN es : " + str(user_response.json()["authToken"]))
    print("\n" + "el contenido de la tabla es :  " + str(users_table_response.text.count(str_user)))
